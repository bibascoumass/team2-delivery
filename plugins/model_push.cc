// COPY OF: https://gitlab.com/HCRLab/stingray-robotics/cs603_particle_filter/-/blob/main/plugins/model_push.cc
...
public:
  void Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf) {
    ...
    // Allow SDF <topicName> to override the default /cmd_vel topic.
